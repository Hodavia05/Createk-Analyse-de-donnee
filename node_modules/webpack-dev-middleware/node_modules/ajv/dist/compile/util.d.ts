import type { AnySchema, EvaluatedProperties, EvaluatedItems } from "webpack-dev-middleware/node_modules/ajv/dist/typesdev-middleware/node_modules/ajv/dist/types";
import type { SchemaCxt, SchemaObjCxt } from "webpack-dev-middleware/node_modules/ajv/dist/compileebpack-dev-middleware/node_modules/ajv/dist/compile";
import { Code, Name, CodeGen } from "webpack-dev-middleware/node_modules/ajv/dist/compile/codegenev-middleware/node_modules/ajv/dist/compile/codegen";
import type { Rule, ValidationRules } from "webpack-dev-middleware/node_modules/ajv/dist/compile/rules-dev-middleware/node_modules/ajv/dist/compile/rules";
