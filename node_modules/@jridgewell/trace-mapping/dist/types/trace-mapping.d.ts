import type { SourceMapSegment } from '@jridgewell/trace-mapping/dist/types/sourcemap-segmentapping/dist/types/sourcemap-segment';
import type { SourceMapV3, DecodedSourceMap, EncodedSourceMap, InvalidOriginalMapping, OriginalMapping, InvalidGeneratedMapping, GeneratedMapping, SourceMapInput, Needle, SourceNeedle, SourceMap, EachMapping } from '@jridgewell/trace-mapping/dist/types/typeswell/trace-mapping/dist/types/types';
export type { SourceMapSegment } from '@jridgewell/trace-mapping/dist/types/sourcemap-segmentapping/dist/types/sourcemap-segment';
export type { SourceMap, DecodedSourceMap, EncodedSourceMap, Section, SectionedSourceMap, SourceMapV3, Bias, EachMapping, GeneratedMapping, InvalidGeneratedMapping, InvalidOriginalMapping, Needle, OriginalMapping, OriginalMapping as Mapping, SectionedSourceMapInput, SourceMapInput, SourceNeedle, XInput, EncodedSourceMapXInput, DecodedSourceMapXInput, SectionedSourceMapXInput, SectionXInput, } from '@jridgewell/trace-mapping/dist/types/typeswell/trace-mapping/dist/types/types';
export declare const LEAST_UPPER_BOUND = -1;
export declare const GREATEST_LOWER_BOUND = 1;
export { AnyMap } from '@jridgewell/trace-mapping/dist/types/any-mapll/trace-mapping/dist/types/any-map';
